...
int main() {
    ...
    all.open("AllData.txt", ios::out|ios::binary);
    innocRate.open("innoculationRateData.txt", ios::out|ios::binary);
    ...
    all << s;
    all.close();
    /*People peeps("9 - 1 - 0", 9, 1, 0);
    propExport(peeps, peeps.identifier() + ".txt");*/
